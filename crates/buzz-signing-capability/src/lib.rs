...
pub use policy::{CapabilityScope, HttpPathRule, HttpScopeRule, ScopeBuildError, ScopeBuilder};
pub use protocol::{
...
pub use registry::{
    AuthorizationOutcome, AuthorizationPermit, AuthorizedOperation, BudgetLimits,
