...
pub fn spawn_agent_child(
    ...
    // Use native command construction so Windows wrapper harnesses are executable.
    let mut command =
        crate::managed_agents::readiness::cli_probe::command_for_binary(&resolved_acp_command);
