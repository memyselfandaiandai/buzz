...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_human_card,
            answer_human_card,
            get_spend_guard_status,
            update_spend_guard_config,
            toggle_spend_guard_pause,
            list_curated_skills,
            preflight_skill_capture,
            dry_run_skill_capability,
            get_workspace_observer,
            ...
            trigger_automation_wake,
            get_secret_backend_status,
            set_secret_backend,
            configure_bws_credentials,
            clear_bws_credentials,
            test_secret_backend,
            get_secret_access_overview,
            publish_note,
            get_contact_list,
            set_contact_list,
            get_notes_timeline,
